                            ...
                            <div class="categori-dropdown-wrap categori-dropdown-active-large">
                                <ul>
                                    ...
                                    <li><a href="{{route('shop')}}"><i class="surfsidemedia-font-cpu"></i>Consumer
                                            Electronics</a></li>
                                    <li><a href="{{route('shop')}}"><i class="surfsidemedia-font-diamond"></i>Jewelry &
                                            Accessories</a></li>
                                    <li><a href="{{route('shop')}}"><i class="surfsidemedia-font-home"></i>Home & Garden</a>
                                    </li>
                                    ...
                                    <li>
                                        <ul class="more_slide_open" style="display: none;">
                                            <li><a href="{{route('shop')}}"><i class="surfsidemedia-font-desktop"></i>Beauty,
                                                    Health</a></li>
                                            <li><a href="{{route('shop')}}"><i class="surfsidemedia-font-cpu"></i>Bags and
                                                    Shoes</a></li>
                                            <li><a href="{{route('shop')}}"><i class="surfsidemedia-font-diamond"></i>Consumer
                                                    Electronics</a></li>
                                            <li><a href="{{route('shop')}}"><i class="surfsidemedia-font-home"></i>Automobiles
                                                    & Motorcycles</a></li>
                                        </ul>
                                    </li>
                                </ul>
                ...
                <div class="mobile-menu-wrap mobile-header-border">
                    <div class="main-categori-wrap mobile-header-border">
                        ...
                        <div class="categori-dropdown-wrap categori-dropdown-active-small">
                            <ul>
                                <li><a href="{{route('shop')}}"><i class="surfsidemedia-font-dress"></i>Women's Clothing</a>
                                </li>
                                <li><a href="{{route('shop')}}"><i class="surfsidemedia-font-tshirt"></i>Men's Clothing</a>
                                </li>
                                <li> <a href="{{route('shop')}}"><i class="surfsidemedia-font-smartphone"></i> Cellphones</a>
                                </li>
                                <li><a href="{{route('shop')}}"><i class="surfsidemedia-font-desktop"></i>Computer &
                                        Office</a></li>
                                <li><a href="{{route('shop')}}"><i class="surfsidemedia-font-cpu"></i>Consumer Electronics</a>
                                </li>
                                ...
                                <li><a href="{{route('shop')}}"><i class="surfsidemedia-font-teddy-bear"></i>Mother & Kids</a>
                                </li>
