                ...
                <div class="row">
                                ...
                                <div class="product-cart-wrap mb-30">
                                    <div class="product-img-action-wrap">
                                        <div class="product-img product-img-zoom">
                                            <a href="product-details.html">
                                                <img class="default-img"
                                                    src="a{{ asset('ssets/imgs/shop/product-11-1.jpg') }}"
                                                    alt="">
                                                <img class="hover-img"
                                                    src="a{{ asset('ssets/imgs/shop/product-11-2.jpg') }}"
                                                    alt="">
                                            </a>
                                        </div>
                                        <div class="product-action-1">
                                ...
                                <div class="product-cart-wrap mb-30">
                                    <div class="product-img-action-wrap">
                                        <div class="product-img product-img-zoom">
                                            <a href="product-details.html">
                                                <img class="default-img"
                                                    src="a{{ asset('ssets/imgs/shop/product-13-1.jpg') }}"
                                                    alt="">
                                                <img class="hover-img"
                                                    src="a{{ asset('ssets/imgs/shop/product-13-2.jpg') }}"
                                                    alt="">
                                            </a>
                                        </div>
                                        <div class="product-action-1">
                    ...
                    <div class="col-lg-3 primary-sidebar sticky-sidebar">
                        ...
                        <div class="banner-img wow fadeIn mb-45 animated d-lg-block d-none">
                            <img src="assets/imgs/banner/banner-11.jpg"
                                alt="{{ asset('">
